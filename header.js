(async function(){
  ...
  try{
    ...
    mount.innerHTML='<nav class="global-header global-fallback" aria-label="Main navigation"><a href="index.html">JMBNR</a><a href="activities.html">Activities</a><a href="careers.html">Career Paths</a><a href="join.html">Join</a><a href="member.html">Member area</a></nav>';
  }
})();
